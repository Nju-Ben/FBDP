...
public class wordcount2 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    FileOutputFormat.setOutputPath(job, new Path("output/wordcount/temp8"));//先将词频统计任务的输出结果写到临时目  
    ...
    {  
        ...
        FileInputFormat.addInputPath(sortJob, new Path("output/wordcount/temp8"));  
